...
from sistema_buap_api.views import tecnicos
...
urlpatterns = [
    ...
    #Create Maestro
        path('tecnicos/', tecnicos.TecnicosView.as_view()),
    #Maestro Data
        path('lista-tecnicos/', tecnicos.TecnicosAll.as_view()),
    #Edit Maestro
        path('tecnicos-edit/', tecnicos.TecnicosViewEdit.as_view()),
    #Login
